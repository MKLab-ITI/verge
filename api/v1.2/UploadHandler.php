...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
    	$upload_directory = '/../../camera_shots/';
        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).$upload_directory,
            'upload_url' => $this->get_full_url().$upload_directory,
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            // the redirect parameter, e.g. $upload_directory.
    ...
    protected function get_unique_filename($file_path, $name, $size, $type, $error,$index, $content_range) {
        ...
        while(is_file($this->get_upload_path($name))) {
            ...
            $name = $path_parts['filename']."_".$_SERVER['REQUEST_TIME'].".".$path_parts['extension'];
        }
        return $name;
    }
